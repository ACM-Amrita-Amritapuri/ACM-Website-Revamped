...
export default function PersonCard({ person, index = 0 }) {
  ...
  return <article className="person-card">
    <div className="person-image"><Image src={person.image} alt={person.name} fill sizes="(max-width: 600px) 90vw, 280px" quality={65} priority={index < 4} /><span>MEMBER / {String(index + 1).padStart(2,"0")}</span></div>
